            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('cliente.store')}}" method="POST">
                        @csrf
                        <div class="mb-6">
                            <label for="cedula" class="text-sm font-medium text-gray-900 block mb-2">Carnet de Identidad:</label>
                        ...
                        <div class="mb-6">
                            <label for="celular"
                                class="text-sm font-medium text-gray-900 block mb-2">Celular:</label>
